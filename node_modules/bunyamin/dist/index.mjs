...
class ThreadGroups {
  constructor(bunyamin) {
    Object.defineProperty(this, _logAddition, {
      value: _logAddition2
    });
    Object.defineProperty(this, _bunyamin, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldLooseBase(this, _bunyamin)[_bunyamin] = bunyamin;
...
function _logAddition2(group, action) {
  ...
  _classPrivateFieldLooseBase(this, _bunyamin)[_bunyamin].trace({
    cat: 'bunyamin'
...
function normalizeOptions(options) {
  ...
  options.threadGroups = [...((_options$threadGroups = options.threadGroups) != null ? _options$threadGroups : [])].map((threadGroup, index) => typeof threadGroup === 'string' ? {
    id: threadGroup,
    displayName: threadGroup
...
class BunyanTraceEventStream extends Transform {
  constructor(userOptions = {}) {
    ...
    for (const threadGroup of options.threadGroups) {
      _classPrivateFieldLooseBase(this, _threadGroupDispatcher)[_threadGroupDispatcher].registerThreadGroup(threadGroup);
    }
  }
